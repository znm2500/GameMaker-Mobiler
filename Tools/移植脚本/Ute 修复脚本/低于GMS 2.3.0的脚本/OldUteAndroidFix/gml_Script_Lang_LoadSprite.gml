...
if (!file_exists("locale/" + LANG + "/" + "sprite.txt"))
    return 0;

var LIST = Lang_LoadFileToString("locale/" + LANG + "/" + "sprite.txt");
...
while (!file_text_eof(FILE))
{
    ...
    if (file_exists(PATH))
    {
        ...
        var remove_back = ini_read_real("sprite", "remove_background", 0);
        var smooth = ini_read_real("sprite", "is_smooth", 0);
