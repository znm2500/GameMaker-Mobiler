...
for (i = 0; i < 4; i++)
{
    ...
    {
        if (device_mouse_x_to_gui(i) >= 560 && device_mouse_x_to_gui(i) <= 640 && device_mouse_y_to_gui(i) >= 51)
        {
            cz = 0.5;
            _ak = mk_z_button;
        }
        else if (device_mouse_x_to_gui(i) > 640)
        {
            cz = 0.5;
            _ak = mk_z_button;
        }
        ...
        else if (device_mouse_x_to_gui(i) >= 560 && device_mouse_x_to_gui(i) <= 640 && device_mouse_y_to_gui(i) <= 50)
        {
            dm = 0.5;
...
if (dm == 0.5 && !keyboard_check(mk_up_right_button))
    keyboard_key_press(mk_up_right_button);

if (mb == 0.5 && !keyboard_check(mk_up_left_button))
...
if (dm == 1 && keyboard_check(mk_up_right_button))
    keyboard_key_release(mk_up_right_button);

if (mb == 1 && keyboard_check(mk_up_left_button))
